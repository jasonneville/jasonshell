...
- Paging semantics:
  ...
  - `listStackFolder()` emits baseline diagnostics to the console (`stack-folder-listing-diagnostics`) with folder-open duration, per-page duration, page item counts, payload counts, and backend icon-resolution counters/timings.
