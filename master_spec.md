...
- `jasonshell-settings-v1.json`:
  ...
  - Format is pretty JSON object `{ schema: "jasonshell.settings", version: 1, ui, search, workspaces, taskHistory }` with camelCase fields over IPC and Rust `task_history` internally.
  - Version 1 defaults are `ui.activeWorkspaceId = null`, `ui.enableDiagnosticsExport = false`, `ui.searchMode = "topRight"`, `search.resultLimit = 50`, `search.everything.enabled = true`, `search.everything.installMode = "ask"`, `search.everything.sdkSource = "system"`, `search.everything.maxResults = 100`, `search.everything.fullPathSearch = true`, `search.everything.sort = "nameAsc"`, `search.everything.contentSearchEnabled = false`, empty `workspaces`, and empty `taskHistory`.
