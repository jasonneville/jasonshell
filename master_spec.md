...
- `read_stack_folder` normalizes existing directories and returns `StackFolderPage` with `offset`, `limit`, `total`, `hasMore`, partial warnings, optional `sessionId`, and optional paging diagnostics.
