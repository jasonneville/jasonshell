...
9. `tray-panel` is a renderer-driven auxiliary tray-icon popup. Rust owns anchored placement, show/hide, and focus-loss close event emission; Svelte owns icon-grid state (loading/error/empty) and left/right relay intent dispatch to `system_tray` commands.
