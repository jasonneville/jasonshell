...
- Startup sequence:
  ...
  5. On Windows, call `appbar::activate_shell_surfaces` to register, position, show, and stabilize top/bottom appbars.
  6. On non-Windows, show top/bottom windows without native AppBar integration.
