...
const SOURCE_CONTRACT_INTENTS = {
  architectureContract: [
    ...
    'explorerTaskbarSuppression.test.mjs',
    ...
    'stackBrowserPhase1Safety.test.mjs',
    ...
    'bottomBarPreviewRequestId.test.mjs',
    ...
    'taskbarGalleryContract.test.mjs',
    'taskbarAttentionModel.test.mjs',
    'taskbarSmokeScript.test.mjs',
    'taskbarRuntimeDiagnostics.test.mjs',
    'taskWindowSnapshotPipeline.test.mjs',
